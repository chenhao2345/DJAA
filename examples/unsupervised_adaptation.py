...
def create_model(args):
    model_1 = models.create(args.arch, num_features=args.features, dropout=args.dropout, num_classes=0, pooling_type=args.pooling_type)
...
def lifelong_supervised_trainer(args, dataset_target, model_1, model_1_ema, optimizer, lr_scheduler, evaluator_1_ema,
    ...
    for epoch in range(args.epochs):
        ...
        # # Trainer
        # trainer = PreTrainer(model_1, num_ids, margin=0.0)
        #
...
def main_worker(args):
    ...
    dataset_cuhksysu = get_data('cuhk-sysu', args.data_dir, split=2)
    dataset_msmt = get_data('msmt17', args.data_dir, split=2)

    dataset_market2 = get_data('market1501', args.data_dir, split=1)
    # dataset_duke = get_data('dukemtmc-reid', args.data_dir)
    dataset_cuhksysu2 = get_data('cuhk-sysu', args.data_dir, split=1)
    dataset_msmt2 = get_data('msmt17', args.data_dir, split=1)
    ...
    datasets_eva = [dataset_personx, dataset_market, dataset_cuhksysu, dataset_msmt]
    ...
    save_dir = osp.join(args.logs_dir, 'split_DJAA_dataset21_woRE')
